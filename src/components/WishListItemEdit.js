    ...
    render() {
        ...
        return (
            <div className="item-edit">
                Produto: <input value={item.name} onChange={this.onNameChange} />
                <br />
                Preço: <input value={item.price} onChange={this.onPriceChange} />
                <br />
                Imagem: <input value={item.image} onChange={this.onImageChange} />
                <br />
            </div>
        )
    }
